...
part 'update_item_tracks_req_params.g.dart';
...
class UpdateItemTracksReqParams {
  ...
  const UpdateItemTracksReqParams({required this.orderedFileData});
...
class AudioFileDataReqParams {
  static const defaults = {'exclude': false};

  final String ino;
  final bool exclude;

  /// See [Update a Library Item's Audio Tracks](https://api.audiobookshelf.org/#update-a-library-item-39-s-audio-tracks)
  const AudioFileDataReqParams({required this.ino, this.exclude = false});
