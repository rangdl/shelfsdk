...
part 'get_librarys_episodes_response.freezed.dart';
part 'get_librarys_episodes_response.g.dart';

/// See [Get a Library's Recent Episodes](https://api.audiobookshelf.org/#get-a-library-39-s-recent-episodes)
@freezed
abstract class GetLibrarysEpisodesResponse with _$GetLibrarysEpisodesResponse {
