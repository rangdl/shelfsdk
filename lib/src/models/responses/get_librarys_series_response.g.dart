...
_GetLibrarysSeriesResponse _$GetLibrarysSeriesResponseFromJson(
  ...
  filterBy: _$JsonConverterFromJson<String, Filter>(
    json['filterBy'],
    const FilterConverter().fromJson,
  ),
  minified: json['minified'] as bool,
  include: json['include'] as String,
);

Map<String, dynamic> _$GetLibrarysSeriesResponseToJson(
  _GetLibrarysSeriesResponse instance,
) => <String, dynamic>{
