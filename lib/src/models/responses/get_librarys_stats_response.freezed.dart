...
mixin _$GetLibrarysStatsResponse {
 ...
 int get totalItems; int get totalAuthors; int get totalGenres; Duration get totalDuration; List<LibraryItemStats> get longestItems; int get numAudioTracks; int get totalSize; List<LibraryItemSizeStats> get largestItems; List<AuthorStats> get authorsWithCount; List<GenreStats> get genresWithCount;
/// Create a copy of GetLibrarysStatsResponse
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$GetLibrarysStatsResponseCopyWith<GetLibrarysStatsResponse> get copyWith => _$GetLibrarysStatsResponseCopyWithImpl<GetLibrarysStatsResponse>(this as GetLibrarysStatsResponse, _$identity);
...
abstract mixin class $GetLibrarysStatsResponseCopyWith<$Res>  {
  factory $GetLibrarysStatsResponseCopyWith(GetLibrarysStatsResponse value, $Res Function(GetLibrarysStatsResponse) _then) = _$GetLibrarysStatsResponseCopyWithImpl;
@useResult
$Res call({
 int totalItems, int totalAuthors, int totalGenres, Duration totalDuration, List<LibraryItemStats> longestItems, int numAudioTracks, int totalSize, List<LibraryItemSizeStats> largestItems, List<AuthorStats> authorsWithCount, List<GenreStats> genresWithCount
});
...
/// Create a copy of GetLibrarysStatsResponse
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? totalItems = null,Object? totalAuthors = null,Object? totalGenres = null,Object? totalDuration = null,Object? longestItems = null,Object? numAudioTracks = null,Object? totalSize = null,Object? largestItems = null,Object? authorsWithCount = null,Object? genresWithCount = null,}) {
  return _then(_self.copyWith(
totalItems: null == totalItems ? _self.totalItems : totalItems // ignore: cast_nullable_to_non_nullable
as int,totalAuthors: null == totalAuthors ? _self.totalAuthors : totalAuthors // ignore: cast_nullable_to_non_nullable
as int,totalGenres: null == totalGenres ? _self.totalGenres : totalGenres // ignore: cast_nullable_to_non_nullable
as int,totalDuration: null == totalDuration ? _self.totalDuration : totalDuration // ignore: cast_nullable_to_non_nullable
as Duration,longestItems: null == longestItems ? _self.longestItems : longestItems // ignore: cast_nullable_to_non_nullable
as List<LibraryItemStats>,numAudioTracks: null == numAudioTracks ? _self.numAudioTracks : numAudioTracks // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _GetLibrarysStatsResponse value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _GetLibrarysStatsResponse value)  $default,){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _GetLibrarysStatsResponse value)?  $default,){
final _that = this;
switch (_that) {
case _GetLibrarysStatsResponse() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int totalItems,  int totalAuthors,  int totalGenres,  Duration totalDuration,  List<LibraryItemStats> longestItems,  int numAudioTracks,  int totalSize,  List<LibraryItemSizeStats> largestItems,  List<AuthorStats> authorsWithCount,  List<GenreStats> genresWithCount)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _GetLibrarysStatsResponse() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int totalItems,  int totalAuthors,  int totalGenres,  Duration totalDuration,  List<LibraryItemStats> longestItems,  int numAudioTracks,  int totalSize,  List<LibraryItemSizeStats> largestItems,  List<AuthorStats> authorsWithCount,  List<GenreStats> genresWithCount)  $default,) {final _that = this;
switch (_that) {
case _GetLibrarysStatsResponse():
return $default(_that.totalItems,_that.totalAuthors,_that.totalGenres,_that.totalDuration,_that.longestItems,_that.numAudioTracks,_that.totalSize,_that.largestItems,_that.authorsWithCount,_that.genresWithCount);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int totalItems,  int totalAuthors,  int totalGenres,  Duration totalDuration,  List<LibraryItemStats> longestItems,  int numAudioTracks,  int totalSize,  List<LibraryItemSizeStats> largestItems,  List<AuthorStats> authorsWithCount,  List<GenreStats> genresWithCount)?  $default,) {final _that = this;
switch (_that) {
case _GetLibrarysStatsResponse() when $default != null:
return $default(_that.totalItems,_that.totalAuthors,_that.totalGenres,_that.totalDuration,_that.longestItems,_that.numAudioTracks,_that.totalSize,_that.largestItems,_that.authorsWithCount,_that.genresWithCount);case _:
  return null;
...
class _GetLibrarysStatsResponse implements GetLibrarysStatsResponse {
  const _GetLibrarysStatsResponse({required this.totalItems, required this.totalAuthors, required this.totalGenres, required this.totalDuration, required final  List<LibraryItemStats> longestItems, required this.numAudioTracks, required this.totalSize, required final  List<LibraryItemSizeStats> largestItems, required final  List<AuthorStats> authorsWithCount, required final  List<GenreStats> genresWithCount}): _longestItems = longestItems,_largestItems = largestItems,_authorsWithCount = authorsWithCount,_genresWithCount = genresWithCount;
  factory _GetLibrarysStatsResponse.fromJson(Map<String, dynamic> json) => _$GetLibrarysStatsResponseFromJson(json);

@override final  int totalItems;
@override final  int totalAuthors;
@override final  int totalGenres;
@override final  Duration totalDuration;
 final  List<LibraryItemStats> _longestItems;
@override List<LibraryItemStats> get longestItems {
  if (_longestItems is EqualUnmodifiableListView) return _longestItems;
  // ignore: implicit_dynamic_type
  return EqualUnmodifiableListView(_longestItems);
}

@override final  int numAudioTracks;
@override final  int totalSize;
 final  List<LibraryItemSizeStats> _largestItems;
@override List<LibraryItemSizeStats> get largestItems {
...
@override List<AuthorStats> get authorsWithCount {
...
@override List<GenreStats> get genresWithCount {
...
/// @nodoc
abstract mixin class _$GetLibrarysStatsResponseCopyWith<$Res> implements $GetLibrarysStatsResponseCopyWith<$Res> {
  factory _$GetLibrarysStatsResponseCopyWith(_GetLibrarysStatsResponse value, $Res Function(_GetLibrarysStatsResponse) _then) = __$GetLibrarysStatsResponseCopyWithImpl;
@override @useResult
$Res call({
 int totalItems, int totalAuthors, int totalGenres, Duration totalDuration, List<LibraryItemStats> longestItems, int numAudioTracks, int totalSize, List<LibraryItemSizeStats> largestItems, List<AuthorStats> authorsWithCount, List<GenreStats> genresWithCount
});
...
/// Create a copy of GetLibrarysStatsResponse
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? totalItems = null,Object? totalAuthors = null,Object? totalGenres = null,Object? totalDuration = null,Object? longestItems = null,Object? numAudioTracks = null,Object? totalSize = null,Object? largestItems = null,Object? authorsWithCount = null,Object? genresWithCount = null,}) {
  return _then(_GetLibrarysStatsResponse(
totalItems: null == totalItems ? _self.totalItems : totalItems // ignore: cast_nullable_to_non_nullable
as int,totalAuthors: null == totalAuthors ? _self.totalAuthors : totalAuthors // ignore: cast_nullable_to_non_nullable
as int,totalGenres: null == totalGenres ? _self.totalGenres : totalGenres // ignore: cast_nullable_to_non_nullable
as int,totalDuration: null == totalDuration ? _self.totalDuration : totalDuration // ignore: cast_nullable_to_non_nullable
as Duration,longestItems: null == longestItems ? _self._longestItems : longestItems // ignore: cast_nullable_to_non_nullable
as List<LibraryItemStats>,numAudioTracks: null == numAudioTracks ? _self.numAudioTracks : numAudioTracks // ignore: cast_nullable_to_non_nullable
as int,totalSize: null == totalSize ? _self.totalSize : totalSize // ignore: cast_nullable_to_non_nullable
...
mixin _$LibraryItemStats {
 ...
 String get id; String get title; Duration get duration;
/// Create a copy of LibraryItemStats
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$LibraryItemStatsCopyWith<LibraryItemStats> get copyWith => _$LibraryItemStatsCopyWithImpl<LibraryItemStats>(this as LibraryItemStats, _$identity);
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is LibraryItemStats&&(identical(other.id, id) || other.id == id)&&(identical(other.title, title) || other.title == title)&&(identical(other.duration, duration) || other.duration == duration));
}
...
abstract mixin class $LibraryItemStatsCopyWith<$Res>  {
  factory $LibraryItemStatsCopyWith(LibraryItemStats value, $Res Function(LibraryItemStats) _then) = _$LibraryItemStatsCopyWithImpl;
@useResult
$Res call({
...
/// Create a copy of LibraryItemStats
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? title = null,Object? duration = null,}) {
  return _then(_self.copyWith(
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _LibraryItemStats value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _LibraryItemStats value)  $default,){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _LibraryItemStats value)?  $default,){
final _that = this;
switch (_that) {
case _LibraryItemStats() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String title,  Duration duration)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _LibraryItemStats() when $default != null:
return $default(_that.id,_that.title,_that.duration);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String title,  Duration duration)  $default,) {final _that = this;
switch (_that) {
case _LibraryItemStats():
return $default(_that.id,_that.title,_that.duration);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String title,  Duration duration)?  $default,) {final _that = this;
switch (_that) {
case _LibraryItemStats() when $default != null:
return $default(_that.id,_that.title,_that.duration);case _:
  return null;
...
class _LibraryItemStats implements LibraryItemStats {
  const _LibraryItemStats({required this.id, required this.title, required this.duration});
  factory _LibraryItemStats.fromJson(Map<String, dynamic> json) => _$LibraryItemStatsFromJson(json);
...
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$LibraryItemStatsCopyWith<_LibraryItemStats> get copyWith => __$LibraryItemStatsCopyWithImpl<_LibraryItemStats>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$LibraryItemStatsToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _LibraryItemStats&&(identical(other.id, id) || other.id == id)&&(identical(other.title, title) || other.title == title)&&(identical(other.duration, duration) || other.duration == duration));
}
...
/// @nodoc
abstract mixin class _$LibraryItemStatsCopyWith<$Res> implements $LibraryItemStatsCopyWith<$Res> {
  factory _$LibraryItemStatsCopyWith(_LibraryItemStats value, $Res Function(_LibraryItemStats) _then) = __$LibraryItemStatsCopyWithImpl;
@override @useResult
$Res call({
 String id, String title, Duration duration
});
...
/// Create a copy of LibraryItemStats
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? title = null,Object? duration = null,}) {
...
mixin _$LibraryItemSizeStats {
 ...
 String get id; String get title; int get size;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is LibraryItemSizeStats&&(identical(other.id, id) || other.id == id)&&(identical(other.title, title) || other.title == title)&&(identical(other.size, size) || other.size == size));
}
...
@useResult
$Res call({
 String id, String title, int size
});
...
/// Create a copy of LibraryItemSizeStats
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? title = null,Object? size = null,}) {
  return _then(_self.copyWith(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as String,title: null == title ? _self.title : title // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String title,  int size)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _LibraryItemSizeStats() when $default != null:
return $default(_that.id,_that.title,_that.size);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String title,  int size)  $default,) {final _that = this;
switch (_that) {
case _LibraryItemSizeStats():
return $default(_that.id,_that.title,_that.size);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String title,  int size)?  $default,) {final _that = this;
switch (_that) {
case _LibraryItemSizeStats() when $default != null:
return $default(_that.id,_that.title,_that.size);case _:
  return null;
...
class _LibraryItemSizeStats implements LibraryItemSizeStats {
  const _LibraryItemSizeStats({required this.id, required this.title, required this.size});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _LibraryItemSizeStats&&(identical(other.id, id) || other.id == id)&&(identical(other.title, title) || other.title == title)&&(identical(other.size, size) || other.size == size));
}
...
/// Create a copy of LibraryItemSizeStats
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? title = null,Object? size = null,}) {
...
class _AuthorStats implements AuthorStats {
  const _AuthorStats({required this.id, required this.name, required this.count});
...
mixin _$GenreStats {
 ...
 String get genre; int get count;
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String genre,  int count)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _GenreStats() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String genre,  int count)  $default,) {final _that = this;
switch (_that) {
case _GenreStats():
return $default(_that.genre,_that.count);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String genre,  int count)?  $default,) {final _that = this;
switch (_that) {
case _GenreStats() when $default != null:
return $default(_that.genre,_that.count);case _:
  return null;
