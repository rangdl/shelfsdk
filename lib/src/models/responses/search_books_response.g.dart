...
SearchBooksResponseGoogle _$SearchBooksResponseGoogleFromJson(
...
Map<String, dynamic> _$SearchBooksResponseGoogleToJson(
  SearchBooksResponseGoogle instance,
) => <String, dynamic>{
  'id': instance.id,
...
SearchBooksResponseOpenLibrary _$SearchBooksResponseOpenLibraryFromJson(
  Map<String, dynamic> json,
...
Map<String, dynamic> _$SearchBooksResponseOpenLibraryToJson(
  SearchBooksResponseOpenLibrary instance,
) => <String, dynamic>{
  'title': instance.title,
  'author': instance.author,
...
SearchBooksResponseITunes _$SearchBooksResponseITunesFromJson(
  Map<String, dynamic> json,
...
Map<String, dynamic> _$SearchBooksResponseITunesToJson(
  SearchBooksResponseITunes instance,
) => <String, dynamic>{
  'id': instance.id,
...
SearchBooksResponseAudible _$SearchBooksResponseAudibleFromJson(
  Map<String, dynamic> json,
  ...
  duration: const DurationMinConverter().fromJson(
...
Map<String, dynamic> _$SearchBooksResponseAudibleToJson(
  SearchBooksResponseAudible instance,
) => <String, dynamic>{
  'title': instance.title,
  'subtitle': instance.subtitle,
  'author': instance.author,
...
SearchBooksResponseFantLab _$SearchBooksResponseFantLabFromJson(
  Map<String, dynamic> json,
...
Map<String, dynamic> _$SearchBooksResponseFantLabToJson(
  SearchBooksResponseFantLab instance,
) => <String, dynamic>{
  'id': instance.id,
  'title': instance.title,
  'subtitle': instance.subtitle,
...
_AudibleSeries _$AudibleSeriesFromJson(Map<String, dynamic> json) =>
    _AudibleSeries(
      series: json['series'] as String,
      sequence: json['sequence'] as String,
    );

Map<String, dynamic> _$AudibleSeriesToJson(_AudibleSeries instance) =>
    <String, dynamic>{'series': instance.series, 'sequence': instance.sequence};
