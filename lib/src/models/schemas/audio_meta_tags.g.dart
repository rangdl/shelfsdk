...
_AudioMetaTags _$AudioMetaTagsFromJson(Map<String, dynamic> json) =>
    _AudioMetaTags(
...
Map<String, dynamic> _$AudioMetaTagsToJson(_AudioMetaTags instance) =>
    <String, dynamic>{
      ...
      'tagSubtitle': ?instance.tagSubtitle,
      'tagAlbumArtist': ?instance.tagAlbumArtist,
      'tagDate': ?instance.tagDate,
      'tagComposer': ?instance.tagComposer,
      'tagPublisher': ?instance.tagPublisher,
      'tagComment': ?instance.tagComment,
      'tagDescription': ?instance.tagDescription,
      'tagEncoder': ?instance.tagEncoder,
      'tagEncodedBy': ?instance.tagEncodedBy,
      'tagIsbn': ?instance.tagIsbn,
      'tagLanguage': ?instance.tagLanguage,
      'tagASIN': ?instance.tagASIN,
      'tagOverdriveMediaMarker': ?instance.tagOverdriveMediaMarker,
      'tagOriginalYear': ?instance.tagOriginalYear,
      'tagReleaseCountry': ?instance.tagReleaseCountry,
      'tagReleaseType': ?instance.tagReleaseType,
      'tagReleaseStatus': ?instance.tagReleaseStatus,
      'tagISRC': ?instance.tagISRC,
      'tagMusicBrainzTrackId': ?instance.tagMusicBrainzTrackId,
      'tagMusicBrainzAlbumId': ?instance.tagMusicBrainzAlbumId,
      'tagMusicBrainzAlbumArtistId': ?instance.tagMusicBrainzAlbumArtistId,
      'tagMusicBrainzArtistId': ?instance.tagMusicBrainzArtistId,
    };
