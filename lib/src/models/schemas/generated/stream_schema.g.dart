...
_StreamSchema _$StreamSchemaFromJson(Map<String, dynamic> json) =>
    _StreamSchema(
      ...
      segmentLength: const DurationSecConverter().fromJson(
        (json['segmentLength'] as num).toInt(),
      ),
...
Map<String, dynamic> _$StreamSchemaToJson(
  _StreamSchema instance,
) => <String, dynamic>{
  'id': instance.id,
  'userId': instance.userId,
  'libraryItem': instance.libraryItem.toJson(),
  'episode': instance.episode?.toJson(),
  'segmentLength': const DurationSecConverter().toJson(instance.segmentLength),
