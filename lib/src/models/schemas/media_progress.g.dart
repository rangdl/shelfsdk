...
MediaProgressBase _$MediaProgressBaseFromJson(Map<String, dynamic> json) =>
    MediaProgressBase(
...
Map<String, dynamic> _$MediaProgressBaseToJson(
  MediaProgressBase instance,
) => <String, dynamic>{
  'id': instance.id,
...
MediaProgressWithMedia _$MediaProgressWithMediaFromJson(
...
Map<String, dynamic> _$MediaProgressWithMediaToJson(
  MediaProgressWithMedia instance,
) => <String, dynamic>{
  'id': instance.id,
  'libraryItemId': instance.libraryItemId,
  'episodeId': instance.episodeId,
