...
Map<String, dynamic> _$PlaybackSessionBaseToJson(
  ...
  'timeListening': const DurationPreciseSecondsConverter().toJson(
    instance.timeListening,
  ),
...
PlaybackSessionExpanded _$PlaybackSessionExpandedFromJson(
...
Map<String, dynamic> _$PlaybackSessionExpandedToJson(
  PlaybackSessionExpanded instance,
) => <String, dynamic>{
  'id': instance.id,
  'userId': instance.userId,
  'libraryId': instance.libraryId,
